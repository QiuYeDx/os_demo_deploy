...
export const H2 = styled.div`
    ...
    left: ${props => props.inputLeft || "48px"};
`
...
export const LabelText = styled.div`
  ...
  left: ${props => props.left || '600px'};
  padding: 16px 0 12px 0;
  ${props => props.hasBorder ? "border: 1px solid #ccc; background-color: #f5f5f5;" : "border: none;"};
  text-align: center;
  width: 160px;
  height: 24px;
  font-size: 20px;
...
export const Borderline = styled.div`
  position: absolute;
  top: ${props => props.top || '320px'};
  left: ${props => props.left || '720px'};
  padding: 16px 0 12px 0;
  border: 1px solid #ccc;
  text-align: center;
  width: 720px;
...
export const ProcessList = styled.div`
  position: absolute;
  top: ${props => props.top || '330px'};
  left: ${props => props.left || '721px'};
  padding-left: 39px;
  //border: 1px solid #ccc;
  width: 680px;
  height: 54px;
